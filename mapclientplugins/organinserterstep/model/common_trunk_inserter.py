...
calling SSV tools to derive the in-body coordinates for insertion.
"""
import os

from cmlibs.zinc.context import Context
from mapclientplugins.organinserterstep.model.base_output_file import BaseOutputFile
from ssvtools.query_structure import get_in_body_coordinates
...
class CommonTrunkInserter(BaseOutputFile):
    ...
    def __init__(self, organ_file, template_file, output_directory, trunk_group_name):
        ...
        get_in_body_coordinates(region, "coordinates", tmp_region, "coordinates", trunk_group_name,
